class SegmentTree:
    ...
    def query(self, i, l, r, ql, qr) -> int:
        ...
        if ql<=l<=r<=qr: # this returns (l,r) => remaining will get added subsequently (ql,l) and (r,qr)
            return self.st[i]
...
print(st.query(1, 0, n-1, 3, 6))

# update: 5->15 arr[5] = 7 -> 15
# querying: [3:6] = [1,2,15,8] = 26
